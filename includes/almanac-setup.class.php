...
class Almanac_events
{
    ...
    <table class="form-table">
        <tbody>
            ...
            <tr valign="top">
                ...
                <td>
                    ...
                    <div id="showhide">
                        ...
                        <div id="mapid" style="float:left; width:500px; height:400px; margin-right: 10px;">
            ...
            <tr valign="top">
                <th scope="row">
                    <label for="tickets">Ticket/s URL</label>
                </th>
                <td>
                    ...
                    <tr valign="top">
                        ...
                        <td>
                            ...
                            <select name="display_author">
                                ...
                                <option <?php if ($display_author == 'none') {
                                            echo 'selected="selected" ';
                                        } ?>value="none">None</option>

                                <option <?php if ($display_author == 'parent') {
                                            echo 'selected="selected" ';
                                        } ?>value="parent">A parent calendar that shows events from all users</option>

                                <option <?php if ($display_author == 'all') {
                                            echo 'selected="selected" ';
                    ...
                    <tr valign="top">
                        ...
                        <td>
                            ...
                            <select name="author_meta">
                                ...
                                <option <?php if ($author_meta == 'first_last') {
                                            echo 'selected="selected" ';
                                        } ?>value="first_last">First name Last name</option>

                                <option <?php if ($author_meta == 'first') {
                                            echo 'selected="selected" ';
                                        } ?>value="first">First name</option>

                                <option <?php if ($author_meta == 'username') {
                                            echo 'selected="selected" ';
                                        } ?>value="username">Username</option>

                                <option <?php if ($author_meta == 'email') {
                                            echo 'selected="selected" ';
